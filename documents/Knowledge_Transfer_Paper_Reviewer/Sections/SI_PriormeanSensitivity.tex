...
\caption{\rev{Per-state EnKF stability under different prior mean parameter perturbations for all six datasets. Green cells indicate a stable trajectory; red cells indicate an unstable trajectory. The $0\%$ column is the nominal case used throughout the paper, corresponding to prior mean parameter values taken from Kotidis \textit{et al.}~\cite{Kotidis2019Model-basedCulture}. Asparagine in Cell Line B Feed C and Feed U is flagged unstable at $-20\%$.}}
