...
The parameters showing the strongest posterior convergence in this work, specifically growth-rate-linked parameters and lactate kinetic constants, broadly correspond to those identified as most influential by sensitivity analysis in related CHO mechanistic models \cite{Kotidis2019UseCultures}. This correspondence supports the interpretation above. This correspondence does not imply that EnKF replaces GSA as a systematic identifiability tool, but it demonstrates that the dynamic evolution of the parameter ensemble provides meaningful, data-grounded insight into model sensitivity under the specific conditions of each new process system.
}
