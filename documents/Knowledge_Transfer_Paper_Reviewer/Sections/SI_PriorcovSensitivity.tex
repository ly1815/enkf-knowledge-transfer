...
\caption{\rev{Per-state EnKF stability under different prior covariance widths for all six datasets. Green cells indicate a stable trajectory; red cells indicate an unstable trajectory. The $1.0\times$ column is the nominal case used throughout the paper, corresponding to the prior covariance values reported in SI Section~F and used in the EnKF parameter estimation.}}
